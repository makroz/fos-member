    ...
    <>
      <div className={`${clase} inline-flex `}>
        ...
        <div className="relative  items-center   cursor-pointer">
          ...
          />
          <div className="w-9 h-5 pt-1 px-1 text-[8px] text-right bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all  peer-checked:bg-blue-600  peer-checked:text-white peer-checked:text-left">
            {props.value == (props.optionValue[0] ? props.optionValue[0] : "Y")
              ? props.optionLabel[0]
              : props.optionLabel[1]}
          </div>
